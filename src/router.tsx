...
export const router = createBrowserRouter([
  { element: <RouteShell />, errorElement: <RouteErrorPage />, children: [
  ...
  { element: <ProtectedRoute />, children: [
    { path: '/dashboard', element: <RequireAdmin />, children: [{ element: <AdminLayout />, children: [
      ...
      { path: 'users', element: <PermissionGate permission='users.view'><UserRolesPage /></PermissionGate> },
      { path: 'roles', element: <PermissionGate permission='roles.view'><RolesPermissionsPage /></PermissionGate> },
      { path: 'settings', element: <PermissionGate permission='welfareSettings.view'><SystemSettingsPage /></PermissionGate> },
      { path: 'members', element: <PermissionGate permission='officialsPortal.members.view'><MembersPage /></PermissionGate> },
      { path: 'ledger', element: <PermissionGate permission='ledger.journal.view'><LedgerHubPage /></PermissionGate> },
      { path: 'ledger/journals', element: <Navigate to="/dashboard/ledger?tab=journals" replace /> },
      { path: 'ledger/accounts', element: <Navigate to="/dashboard/ledger?tab=accounts" replace /> },
      ...
      { path: 'vouchers', element: <PermissionGate permission='officialsPortal.vouchers.view'><VouchersPage /></PermissionGate> },
    ...
    { path: '/officials', element: <RequireOfficial />, children: [{ element: <OfficialsLayout />, children: [
      ...
      { path: 'members', element: <PermissionGate permission='officialsPortal.members.view'><MembersPage /></PermissionGate> },
      { path: 'ledger', element: <PermissionGate permission='ledger.journal.view'><LedgerHubPage /></PermissionGate> },
      { path: 'ledger/journals', element: <Navigate to="/officials/ledger?tab=journals" replace /> },
      { path: 'ledger/accounts', element: <Navigate to="/officials/ledger?tab=accounts" replace /> },
      { path: 'ledger/financial-years', element: <PermissionGate permission='financialYears.view'><FinancialYearsPage /></PermissionGate> },
      { path: 'contributions', element: <PermissionGate permission='officialsPortal.contributions.view'><ContributionsPage /></PermissionGate> },
      { path: 'loans', element: <PermissionGate permission='officialsPortal.loans.view'><LoansPage /></PermissionGate> },
      { path: 'vouchers', element: <PermissionGate permission='officialsPortal.vouchers.view'><VouchersPage /></PermissionGate> },
    ...
    { path: '/member', element: <RequireMember />, children: [{ element: <MemberLayout />, children: [
      ...
      { path: 'meetings/:id', element: <MemberMeetingDetailPage /> },
